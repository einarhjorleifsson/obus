...
The parquet data source is as of now **not** a mirror of the data residing at ICES, it is just a copy that may be some weeks old. If you want an up-to-date mirror you are better off for now using a slower route, doing:
